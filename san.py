...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="Em0LQmdP30oIRC0F0lbb.BThkCee70z0HnBVOuvBn6W.vk72v2mv1cKqqE/fhChBGudRCk4Mjpo0YZI0ZU/PuXU=")
cl.loginResult()
#vidia
kt = LINETCR.LINE()
kt.login(token="Em1lfcr3dlMzDsPXWwoa.CZgRpE2PgJOBF+NlS+sJoG.YLlu+/h8p+oPMA7gkAxiTfDYBjjDMIeEgRITww6FIRM=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EmzHD2gJzKbMomIe6dd5.hvuIx6izAXCh7kigp+OEfq.soRFRwzmOf3sAN707ctjKp7EesZ61vuE6S2OIE3+ucg=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
ki.login(token="EmkWWgjDvCKHH2iQ677b.I9YBMfRqAE5FKjP6B2coYW.3E5Ku7LIJBYtf9KoBiv96m7WpqmLApFmv4hH99sjcyU=")
ki.loginResult()
#fawn
kk = LINETCR.LINE()
kk.login(token="Emu2BHGHT4Fjv4pe5iN2.N/RlxRz2fWJfjPHay81q4G.C2iwLBuYrV1x3zVCLshrW7NZZIumQXGQpiDF3F5kkIg=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE()
kc.login(token="EmTCPXx7Y8iqzMNuTmra.sNjt4tJryJMsXVinsRKrwG.2WyKG6j1CfB9IWSQZ/rL+lT+L8FAiDsrJy8qwvQunnU=")
kc.loginResult()
...
admin = ["ud08280cdfddae5309e71fa1d153496da"]
owner = ["ud08280cdfddae5309e71fa1d153496da"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#==================================================================
              ...
              if msg.from_ in admin:
				msg.contentType = 13
				msg.contentMetadata = {'mid': "ud08280cdfddae5309e71fa1d153496da"}
				cl.sendMessage(msg)
