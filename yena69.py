")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EmmCk7WHPx6TJ3omv7ze.WmA6l/6mupZgImKAkC1O3G.M3q+fTJujhPhp3whvztdQeNVJtfx/iPm25dDs8TAMPE=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="EmK4udCzonSmzLC6YPOb.tyEjT4SUhBFf7gJV34m+gW.WvupxcfXsQay680WEajzlsPS36FDQI+Vj3Ibi8eh7M0=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmiBotJ5eCYosunECLPc.cTXHQLZwcjas2Whcxxlhda.SaSmK44Hsu3L/Kqq9L4OJypU3Ld1UWNHzPiOcC/rFuw=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EnjkyLT7OFWFrSfVPKT4.srjUosW4RgcA0sSjVMH6Ta.xqKWZbR4KaEz+WcLzTmB1w/wVUCLXyHsvkJg5TPXe44=")
kt.loginResult()
...
�U_K�✒ Mc:
�U_K�✒ Tl: text
�U_K�✒ Auto join: on/off
�U_K�✒ Auto add: on/off
�U_K�✒ Auto leave: on/off
�U_K�✒ Clock: on/off
�U_K�✒ Share on
�U_K�✒ Add message: text
�U_K�✒ Message:
�U_K�✒ Add comment: text
�U_K�✒ Comment: 
�U_K�✒ Cbroadcast text
�U_K�✒ Gbroadcast text
�U_K�✒ Reject
...
�U_K�✒ Ban @ target
�U_K�✒ Uban @ target
�U_K�✒ Ban -> send contact
�U_K�✒ Unban -> send contact
�U_K�✒ Comment bl/wl
�U_K�✒ Banlist
�U_K�✒ Cekban
�U_K�✒ Clear ban
...
�U_K�✒ Nk @ target
�U_K�✒ Tk @ target
�U_K�✒ Update status my accound
�U_K�✒ Ambilin @ Steal dp target
�U_K�✒ Sampul @ Steal cover target
�U_K�✒ Copy @ All bot copy target
�U_K�✒ Mycopy @ Copy target profile
�U_K�✒ Keluar @ target
�U_K�✒ music
�U_K�✒ .lyric
�U_K�✒ .instagram
...
�U_K�✒ http://line.me/ti/p/Tq1A2KSg0K
           ATTENTION!!!!
       Creator nya dudul plus p3  :v

�U_K�✒ C͍͇̪̲͎̯͎̫̩̽̅̈́̅̌́̍̐ŗ̛͔̳͔̦́̋͛̎e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟t̢̠̻̗̠͙̦͒̉̈̎͂̐͒͑o̸̡̲̜̯̤͚̠̬͊̓̌̄̒͠r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̶̨̻̪͓̦̻̋̾̂̽̎͘͜͜💋🕉unni͡° ͜ʖ ͡°oppa🕉✒ ��✒•┅───── """
...
admin = ["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
owner = ["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
wait = {
    'contact':False,
    'autoJoin':False,
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  ...
                  klist=[ki,kk,kc,kd,ke,kf,kg,kh,kj,kn,ko,kp,kq,kr,ks,kt]
                  kicker = random.choice(klist)
                  kicker.sendText(op.param1,random.choice(klist).getContact(op.param2).displayName + "Jangan Buka Kode QR Njiiir")
                  kicker.kickoutFromGroup(op.param1,[op.param2])
                  Z = random.choice(klist).getGroup(op.param1)
                  Z.preventJoinByTicket = True
                  kicker.updateGroup(Z)
          ...
          if wait["protectinv"] == True:
            ...
            if op.param2 in admin:
              ...
              try:
                ...
                cl.sendText(op.param1, "Mau Ngundang Siapa Ka?\nKk Bukan Admin\nJadi Aku Cancel sekaligus kick aja biar gak nakal lagi😛")
              except:
                klist=[ki,kk,kc,kd,ke,kf,kg,kh,kj,kn,ko,kp,kq,kr,ks,kt]
                kicker = random.choice(klist)
                kicker.kickoutFromGroup(op.param1,[op.param2])
                kicker.cancelGroupInvitation(op.param1, gMembMids)
                kicker.sendText(op.param1, "Mau Ngundang Siapa Ka?\nKk Bukan Admin\nJadi Aku Cancel sekaligus kick aja biar gak nakal lagi😛")
        if op.type == 19:
                if not op.param2 in Bots:
                    try:
...
#======================================
		...
		if wait["protectinv"] == True:
			...
			cl.sendText(msg.to,"protectinv on\n\n"+ datetime.today().strftime('%H:%M:%S'))
		else:
            ...
            elif msg.text in ["Protect:on","Protect on","prot on","Prot on"]:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
            ...
            elif msg.text in ["Protect:off","Protect off","Prot off","prot off"]:
		...
		if wait["protectinv"] == False:
			...
			cl.sendText(msg.to,"protectinv off\n\n"+ datetime.today().strftime('%H:%M:%S'))
		else:
			...
			cl.sendText(msg.to,"protectinv off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["likeOn"] == True: md+="��Auto like : → ✔️\n"
                else:md+="��Auto like : → ❌\n"
                if wait["copy"] == True: md+="��Mimic : → ✔\n"
                else:md+="��Mimic : → ❌\n"
                ...
                if wait["protectinv"] == True: md+="��protectinv : → ✔\n"
                else:md+="��protectinv : → ❌\n"
                if wait["protectionOn"] == True: md+="��Protection : → ✔\n\n"+ datetime.today().strftime('%H:%M:%S')
                else:md+="��Protection : → ❌\n\n"+ datetime.today().strftime('%H:%M:%S')
...
#==========================================
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    profile.statusMessage = string
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"􀜁􀇔􏿿Done Mystatus👉 " + string + "👈")
